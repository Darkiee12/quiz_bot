...
fn json() -> &'static str {
    ...
    [
      ...
      {
        "question": "Which of the following is NOT a function of the control plane?",
        "kind": "choices",
        "choices": [
          {
            "content": "Network device configuration",
            "value": false
          },
          {
            "content": "Routing table updates",
          ...
          {
            "content": "Data packet forwarding (true)",
            "value": true
          },
          {
            "content": "Network monitoring and management",
            "value": false
          }
        ]
      },
      {
        "question": "What is the impact of control plane failures on a computer network?",
        "kind": "choices",
        "choices": [
          {
            "content": "Data packet forwarding is disrupted",
            "value": true
          },
          {
            "content": "Network security is compromised",
            "value": false
          },
          {
            "content": "Network performance is degraded",
            "value": false
          },
          {
            "content": "Network connectivity is lost",
            "value": false
          }
        ]
      },
      {
        "question": "How does IPv6 handle the issue of Network Address Translation (NAT) in IPv4?",
        "kind": "choices",
        "choices": [
          {
            "content": "It uses a similar NAT mechanism as IPv4",
            "value": false
          },
          {
            "content": "It does not address the issue of NAT",
            "value": false
          },
          {
            "content": "It restricts the use of NAT in IPv6 networks",
            "value": false
          },
          {
            "content": "It eliminates the need for NAT by providing a large address space (true)",
            "value": true
          }
        ]
      },
      {
        "question": "Which of the following is a characteristic of the link state routing algorithm?",
        "kind": "choices",
        "choices": [
            {
                "content": "It converges quickly in large networks (true)",
                "value": true
            },
            {
                "content": "It does not require periodic updates",
            ...
            {
                "content": "It is less resource-intensive compared to distance vector routing",
                "value": false
            },
            {
                "content": "It is more suitable for small networks",
                "value": false
            }
        ]
    }
